        ...
        <div class="row">
            <div class="col-sm-9 col-md-9">
                <div class="news-detail">
                    ...
                    <span><?php echo (date("Y-m-d H:i:s",$vo["create_time"])); ?></span>&nbsp;&nbsp;阅读(<i news-id="<?php echo ($vo["news_id"]); ?>" class="news_count node-<?php echo ($vo["news_id"]); ?>"><?php echo ($vo["count"]); ?></i>)
                    <p><?php echo ($vo["content"]); ?></p>
                    <p>（<?php echo ($vo["username"]); ?>）</p>
                    <span>关键字：</span><a href="#"><?php echo ($vo["keywords"]); ?></a>
                </div>
            </div>
            <!--网站右侧信息-->
