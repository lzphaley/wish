	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<ol class="breadcrumb">
					<li>
						<i class="fa fa-dashboard"></i>  <a href="/wish/admin.php?c=position">推荐位内容管理</a>
					</li>
					<li class="active">
			...
			<div class="col-lg-6">
				...
				<form class="form-horizontal" id="singcms-form">
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input value="<?php echo ($vo["title"]); ?>" type="text" name="title" class="form-control" id="inputname" placeholder="请填写标题">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input value="<?php echo ($vo["url"]); ?>"type="text" class="form-control" name="url" id="inputPassword3" placeholder="请url地址">
						</div>
					</div>
					<div class="form-group">
						<label for="inputname" class="col-sm-2 control-label">文章id:</label>
						<div class="col-sm-5">
							<input value="<?php echo ($vo["news_id"]); ?>"type="text" name="news_id" class="form-control" id="inputname" placeholder="如果和文章无关联的可以不添加文章id">
						</div>
					</div>
					<div class="form-group">
...
<script>
	var SCOPE = {
		'save_url' : '/wish/admin.php?c=position&a=add',
		'jump_url' : '/wish/admin.php?c=position&a=index',
...
<!-- /#wrapper -->
<script type="text/javascript" src="/wish/Public/js/admin/form.js"></script>
