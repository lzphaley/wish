...
<div id="page-wrapper">
	...
	<div class="container-fluid">
		...
		<div class="row">
	<div class="col-lg-12">
		<a href="/wish/admin.php?c=basic"><button type="button" class="btn <?php if($type == 1): ?>btn-primary<?php endif; ?>"> 基本配置</button></a>
		<a href="/wish/admin.php?c=basic&a=cache"><button type="button" class="btn <?php if($type == 2): ?>btn-primary<?php endif; ?>"> 缓存配置</button></a>
	</div>
</div>
		<!--<div class="row">-->
		<!--<div class="col-lg-12">-->
			<!--<a href="/wish/admin.php?c=basic&a=cache"><button type="button" class="btn btn-primary"> 缓存配置</button></a>-->
		<!--</div>-->
		<!--</div>-->
		<!-- /.row -->
		<div class="row">
...
<!-- /#wrapper -->
<script src="/wish/Public/js/admin/form.js"></script>
<script>
  $("#cache-index").click(function(){

	var url = '/wish/index.php?c=index&a=build_html';
	var jump_url = '/wish/admin.php?c=basic&a=cache';
	var postData = {};
