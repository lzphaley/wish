...
<script>
    var SCOPE = {
        'edit_url' : '/wish/admin.php?c=position&a=edit',
        'set_status_url' : '/wish/admin.php?c=position&a=setStatus',
        'add_url' : '/wish/admin.php?c=position&a=add',
        'listorder_url' : '/wish/admin.php?c=position&a=listorder',
    }
