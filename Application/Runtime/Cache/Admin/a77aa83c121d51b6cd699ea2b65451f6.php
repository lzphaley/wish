    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    <li>
                        <i class="fa fa-dashboard"></i>  <a href="/wish/admin.php?c=menu">菜单管理</a>
                    </li>
                    <li class="active">
            ...
            <div class="col-lg-6">
                ...
                <form class="form-horizontal" id="singcms-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="radio" name="status" id="optionsRadiosInline1" value="1" <?php if($menu["type"] == 1): ?>checked<?php endif; ?>> 开启
                            <input type="radio" name="status" id="optionsRadiosInline2" value="0"<?php if($menu["type"] == 0): ?>checked<?php endif; ?>> 关闭
                        </div>
...
<script>
    ...
    var SCOPE = {
        'save_url' : '/wish/admin.php?c=menu&a=add',
        'jump_url' : '/wish/admin.php?c=menu',
    }
</script>
