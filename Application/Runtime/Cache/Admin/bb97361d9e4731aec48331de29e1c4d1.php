...
<div id="page-wrapper">
	...
	<div class="col-lg-12">
		...
		<!--<div class="row">-->
		<!--<div class="col-lg-12">-->
			<!--<a href="/wish/admin.php?c=basic"><button type="button" class="btn btn-primary</if>"> 基本配置</button></a>-->
		<!--</div>-->
		<!--</div>-->
		<!-- /.row -->
...
<script>
	var SCOPE = {
		'save_url' : '/wish/admin.php?c=basic&a=add',
		'jump_url' : '/wish/admin.php?c=basic',
	};
