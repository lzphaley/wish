...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  ...
  <div id="page-wrapper">
    ...
    <div class="container-fluid" >
      ...
      <div class="row">
        <form action="/wish/admin.php" method="get">
          <div class="col-md-3">
            <div class="input-group">
              <span class="input-group-addon">栏目</span>
              <select class="form-control" name="catid">
                <option value='' >全部分类</option>
                <?php if(is_array($webSiteMenu)): foreach($webSiteMenu as $key=>$site): ?><option value="<?php echo ($site["menu_id"]); ?>" <?php if($site['menu_id'] == $news['catid']): ?>selected="selected"<?php endif; ?>><?php echo ($site["name"]); ?></option><?php endforeach; endif; ?>
              </select>
            </div>
          </div>
          ...
          <div class="col-md-3">
            <div class="input-group">
              <input class="form-control" name="title" type="text" value="<?php echo ($new["title"]); ?>" placeholder="文章标题" />
            ...
            <form id="singcms-listorder">
              <table class="table table-bordered table-hover singcms-table">
                ...
                <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><span class="sing_cursor glyphicon glyphicon-edit" aria-hidden="true" id="singcms-edit" attr-id="<?php echo ($new["news_id"]); ?>" title="编辑"></span>
                      <a href="javascript:void(0)" id="singcms-delete"  attr-id="<?php echo ($new["news_id"]); ?>"  attr-message="删除" title="删除">
                        <span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span>
                      </a>
                      <a target="_blank" href="/wish/index.php?c=detail&a=view&id=<?php echo ($new["news_id"]); ?>"class="sing_cursor glyphicon glyphicon-eye-open"  attr-id="<?php echo ($new["news_id"]); ?>"  attr-message="预览" title="预览">
                    </td>
...
<script>
  var SCOPE = {
    'edit_url' : '/wish/admin.php?c=content&a=edit',
    'add_url' : '/wish/admin.php?c=content&a=add',
    'set_status_url' : '/wish/admin.php?c=content&a=setStatus',
    'sing_news_view_url' : '/wish/index.php?c=view',
    'listorder_url' : '/wish/admin.php?c=content&a=listorder',
    'push_url' : '/wish/admin.php?c=content&a=push',
  }
</script>
