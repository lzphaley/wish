        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <i class="fa fa-table"></i><?php echo ($nav["name"]); ?>
                    </li>
                </ol>
            </div>
        </div>
...
<script>
    ...
    var SCOPE = {
        'add_url' : '/wish/admin.php?c=menu&a=add',
        'edit_url' : '/wish/admin.php?c=menu&a=edit',
        'set_status_url' : '/wish/admin.php?c=menu&a=setStatus',
        'listorder_url' : '/wish/admin.php?c=menu&a=listorder',
