...
class PositionController extends CommonController{
    ...
    public function add(){
        ...
        if($_POST){
            ...
            if(!$_POST['url']&&!$_POST['news_id']){
                return show(0,'url和newsId不能同时为空');
            }
            ...
            $positions = D("Position")->getNormalPositions();//获取推荐位标识
            $this->assign('positions',$positions);
            $this->display();
        }
    }
    ...
    public function setStatus()
    {
        ...
        return parent::setStatus($data, 'PositionContent'); // TODO: Change the autogenerated stub
    }
    public function listorder()
    {
        return parent::listorder("PositionContent"); // TODO: Change the autogenerated stub
    }
